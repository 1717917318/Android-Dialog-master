    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("内容在此")//显示的消息内容
                        .setTitle("提示");//对话框标题
                ...
                builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(MainActivity.this, "确认完毕", Toast.LENGTH_LONG).show();
                ...
                builder.setNegativeButton("取消", new DialogInterface.OnClickListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(MainActivity.this, "取消完毕", Toast.LENGTH_LONG).show();
                ...
                builder.setNeutralButton("忽略", new DialogInterface.OnClickListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(MainActivity.this, "忽略成功", Toast.LENGTH_LONG).show();
                    }
                });
                builder.show();
            }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // Add action buttons
                Toast.makeText(MainActivity.this, "默认登录账号:abc 密码：123 ", Toast.LENGTH_LONG).show();
